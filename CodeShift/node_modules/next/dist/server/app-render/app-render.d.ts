import type { ActionResult, DynamicParamTypesShort, FlightRouterState, RenderOpts, Segment, CacheNodeSeedData, PreloadCallbacks } from 'next/dist/server/app-render/types';
...
import 'next/dist/server/app-render/clean-async-snapshot.external';
